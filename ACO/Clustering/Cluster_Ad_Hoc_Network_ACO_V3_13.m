  function [CHParams]=Cluster_Ad_Hoc_Network_ACO_V3_13(ProblemParams,BEST_ANT);
...
i=0;
v=0;
 [v,i]=intersect( Node.Cluser_Gatway{ii},Node.Cluster_ID);
 if numel(i)~=0
    Node.Cluser_Gatway{ii}(i)=[];
   i1=0;
   v1=0;
   
%    [v1,i1]=intersect( Node.Cluster_Neighbor{ii},randperm(Node.Cluster_Number));
    Node.Cluster_Neighbor{ii}(i)=[];
