% AssimilateColonies(TheEmpire,AlgorithmParams,ProblemParams)  
      function TheEmpire = AssimilateColonies_for_MinChannel_GN(TheEmpire,AlgorithmParams,ProblemParams,ClusterParams)
...
UPPER=min(N,MaxChannel);
 ...
 AssimialtedPoint=randint(1,1,[1 NumberResourceOfImperialist]);
...
while numel(Value8)%%%%%%%%%%the cluster that has not assined Chanel
     ...
     Adjacent_Cluster=cell2mat(NeighborCluster(Index8(1)));
