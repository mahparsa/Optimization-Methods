   function Country_for_MinChannel = Generat_Country_MinChannel_G_Adjacency(AlgorithmParams,ProblemParams,ClusterParams);
...
p=AlgorithmParams.NumOfCountries   ;
...
for i=1:p
    ...
    Number_CH=min(randint(1,1,[MinChannel MaxChannel]),N); %%%% for each individulal a number of channel is considered.Number channel shows how many color is yuilized for this chromozom.   
