% RevolveColonies(TheEmpire,AlgorithmParams,ProblemParams)  
 function TheEmpire = RevolveColonies_GN(TheEmpire)
...
%
TheEmpire=Remove_Resource_GN(TheEmpire,NumOfRevolvingColonies_group1);
...
%         R = R(1:NumOfRevolvingColonies);
%
TheEmpire=Add_Resource_GN(TheEmpire);
