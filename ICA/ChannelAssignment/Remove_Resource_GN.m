  function TheEmpire=Remove_Resource_GN(TheEmpire,NumOfRevolvingColonies_group1)
...
R=[];
R=randperm(TheEmpire.Colonies.Resource(jj));
Revelotion_Point=R(1:NumOfRemovingRecource);
...
TheEmpire.Colonies.Cost=COST_Country_for_MinChannel(TheEmpire);
end
  end           
