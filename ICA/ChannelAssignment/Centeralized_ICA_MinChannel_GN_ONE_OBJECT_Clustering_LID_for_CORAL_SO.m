...
%%========================COST=================================== 
COSTFUNCTION_for_MinChannel=COST_New_Country_for_MinChannel(Initial,AlgorithmParams,ProblemParams,ClusterParams);
...
%          
          ...
          %%========================COST=================================== 
          Empires(ii).Colonies.Cost=COST_Country_for_MinChannel(Empires(ii),AlgorithmParams,ProblemParams,ClusterParams);
          Empires(ii).Imperialist.Cost=COST_Imperialist_for_MinChannel(Empires(ii),AlgorithmParams,ProblemParams,ClusterParams);
          %%========================COST=================================== 
          TheEmpire = Sort_Cost(Empires(ii),AlgorithmParams,ProblemParams,ClusterParams);
