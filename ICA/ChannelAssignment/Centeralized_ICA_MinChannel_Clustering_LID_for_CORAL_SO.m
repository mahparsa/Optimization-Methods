...
% % 
% % %%%%%%%%%%%%%%%%%%%%%%%%%%clustring%%%%%%%%%%%%
[ClusterParams]=Cluster_Ad_Hoc_Network_LID_3(ProblemParams);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
AlgorithmParams.NumOfCountries = 70;               % Number of initial countries.number of population
...
AlgorithmParams.NumOfDecades =130; %%%Number of itteration
...
%%========================COST=================================== 
COSTFUNCTION_for_MinChannel=COST_New_Country_for_MinChannel_SO(Initial,AlgorithmParams,ProblemParams,ClusterParams);
...
%          
          Empires(ii)=AssimilateColonies_for_MinChannel_GN1(Empires(ii),AlgorithmParams,ProblemParams,ClusterParams);
          %%========================COST=================================== 
          Empires(ii).Colonies.Cost=COST_Country_for_MinChannel_SO(Empires(ii),AlgorithmParams,ProblemParams,ClusterParams);
          Empires(ii).Imperialist.Cost=COST_Imperialist_for_MinChannel_SO(Empires(ii),AlgorithmParams,ProblemParams,ClusterParams);
          %%========================COST=================================== 
          TheEmpire = Sort_Cost(Empires(ii),AlgorithmParams,ProblemParams,ClusterParams);
...
%  MEAN_OtherCost(S,:,:)=Mean_Other_FUN;
 ...
 BEST_Solution(S,:)=Best_country(iteration_number,:);
