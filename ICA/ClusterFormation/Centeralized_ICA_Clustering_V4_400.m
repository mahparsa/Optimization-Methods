...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
AlgorithmParams.NumOfCountries = round(ProblemParams.NODE.Number/10);               % Number of initial countries.number of population
...
elseif AlgorithmParams.RevolutionRate1>0
         ...
         for kk=1:No_Imperialist_For_revolotion
              ...
              if numel(Empires(New_Index).Imperialist.Sequence) >15
