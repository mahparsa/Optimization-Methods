...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
AlgorithmParams.NumOfCountries = 20%round(ProblemParams.NODE.Number/4);               % Number of initial countries.number of population
...
elseif AlgorithmParams.RevolutionRate1>0
         ...
         for kk=1:No_Imperialist_For_revolotion
              ...
              if numel(Empires(New_Index).Imperialist.Sequence) >4
