...
%%========================COST=================================== 
COST_Country_for_Clustering_V1;
...
for ii = 1:numel(Empires)
         ...
         Empires(ii)=AssimilateColonies_for_Clustering_V1(Empires(ii));
          %%========================COST=================================== 
         Empires(ii)=COST_Empires_for_Clustering_V1(Empires(ii));
          %%========================COST=================================== 
         Val=[];
         SortInd=[];
...
if AlgorithmParams.RevolutionRate2>0.2       
         ...
         %%========================COST=================================== 
         Empires(Index)=COST_Empires_for_Clustering_V1(Empires(Index));
          Empires(Index)=COST_Imperialist_for_Clustering_V1(Empires(Index));
         %%========================COST=================================== 
...
elseif AlgorithmParams.RevolutionRate1>0
         ...
         for kk=1:No_Imperialist_For_revolotion
              ...
              Empires(New_Index)=RevolveColonies_for_Clustering_Level1_V1(Empires(New_Index));
         %%========================COST=================================== 
         Empires(New_Index)=COST_Empires_for_Clustering_V1(Empires(New_Index));
          Empires(New_Index)=COST_Imperialist_for_Clustering_V1(Empires(New_Index));
         %%========================COST=================================== 
 ...
 for jj=1: numel(Empires)
          Empires(jj)=COST_Empires_for_Clustering_V1(Empires(jj));
          Empires(jj)=COST_Imperialist_for_Clustering_V1(Empires(jj));
...
%      Min_Other_FUN(Decade,:)=Other_COST(:,I);%%%it means that it is the value of other cost function  when the cost function is minimum. 
   ...
   COST_con(Decade)=COST_Connectivity(Empires(I).Imperialist.Sequence);
